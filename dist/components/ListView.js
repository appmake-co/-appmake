...
var _excluded = ["url", "defaultQuery", "enableSearch", "enableInfiniteLoad", "enableLoadMore", "numSkeletons", "renderItem", "renderSkeleton"];
...
var handleRenderItem = function handleRenderItem(item, i) {
  return /*#__PURE__*/_react.default.createElement(_index.ListViewItem, {
    key: i,
    item: item
  });
};
var handleRenderSkeleton = function handleRenderSkeleton(_, i) {
  return /*#__PURE__*/_react.default.createElement(_index.ListViewSkeleton, {
    key: i
  });
};
