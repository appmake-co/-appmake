...
var FilterMenu = function FilterMenu(_ref) {
  ...
  return /*#__PURE__*/_react.default.createElement(_material.Popover, {
    ...
    sx: sx.header
  }, /*#__PURE__*/_react.default.createElement(_material.Box, null, /*#__PURE__*/_react.default.createElement(_iconsMaterial.FilterList, {
    color: "primary",
    sx: sx.icon
    ...
    color: "textSecondary",
    sx: sx.title
  }, "Search filters")), /*#__PURE__*/_react.default.createElement(_material.Box, {
    sx: sx.content
