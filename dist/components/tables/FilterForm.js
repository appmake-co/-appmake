...
var FilterForm = function FilterForm(_ref) {
  ...
  var handleFilterChange = function handleFilterChange(ev, index) {
    ...
    var updatedFilter = _objectSpread(
      _objectSpread({}, filter),
      {},
      _defineProperty({}, name, value)
    );
    if (name === "field") {
      updatedFilter = _objectSpread(
        _objectSpread({}, updatedFilter),
        {},
        {
          operator: "",
          value: "",
  ...
  var handleAddFilter = function handleAddFilter() {
    var updatedFilters = [].concat(_toConsumableArray(activeFilters), [
      defaultFilter,
    ]);
    setActiveFilters(updatedFilters);
  };
