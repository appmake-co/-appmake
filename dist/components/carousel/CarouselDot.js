...
var CarouselDot = function CarouselDot(_ref) {
  ...
  var onMove = rest.onMove,
    ...
    deviceType = _rest$carouselState.deviceType;
  ...
  return /*#__PURE__*/_react.default.createElement(_material.Button, {
    ...
    sx: _objectSpread(_objectSpread(_objectSpread({}, sx.dot), active && sx.dotActive), styles)
  }));
};
