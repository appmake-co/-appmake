...
var _excluded = ["value", "name", "label", "placeholder", "handleChange"];
...
var JSONInput = function JSONInput(_ref) {
  ...
  var _useState = (0, _react.useState)(defaultValue),
    ...
    jsonValue = _useState2[0],
    setJsonValue = _useState2[1];
  var _useState3 = (0, _react.useState)(false),
    _useState4 = _slicedToArray(_useState3, 2),
    jsonError = _useState4[0],
    setJsonError = _useState4[1];
  var isValidJSON = function isValidJSON(str) {
    try {
      if (JSON.parse(str) && (str === "{}" || Object.keys(JSON.parse(str)).length > 0)) {
        setJsonError(false);
        return true;
      } else {
        setJsonError(true);
  ...
  var handleJSONChange = function handleJSONChange(ev) {
