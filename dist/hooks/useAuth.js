...
var useAuth = function useAuth(props) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 8:
            ...
            if ((_context.t0 === null || _context.t0 === void 0 ? void 0 : _context.t0.status) === 401 || (_context.t0 === null || _context.t0 === void 0 ? void 0 : _context.t0.status) === 404 || _typeof(_context.t0) === undefined) {
  ...
  var resetPassword = /*#__PURE__*/function () {
    var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(password, token) {
      var _resp$data, resp;
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          ...
          case 4:
            resp = _context5.sent;
            if (!(resp !== null && resp !== void 0 && (_resp$data = resp.data) !== null && _resp$data !== void 0 && _resp$data.id)) {
              _context5.next = 11;
              break;
            }
            setCurrentUser(resp.data);
  ...
  var forgotPassword = /*#__PURE__*/function () {
    var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(email) {
  ...
  var magicLink = /*#__PURE__*/function () {
    var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(email, redirectUrl) {
      var resp;
      ...
      return _regeneratorRuntime().wrap(function _callee10$(_context10) {
        while (1) switch (_context10.prev = _context10.next) {
          ...
          case 2:
            ...
            if (resp !== null && resp !== void 0 && (_resp$data2 = resp.data) !== null && _resp$data2 !== void 0 && _resp$data2.authentications) {
              googleAuth = resp.data.authentications.find(function (auth) {
                return auth.provider === "google";
              });
              setGoogleAuthToken(googleAuth.token);
              (0, _cookiesNext.setCookie)("googleAuthToken", googleAuth.token);
            }
          case 4:
          case "end":
