...
var useResource = function useResource(_ref) {
  var url = _ref.url,
    ...
    defaultQuery =
      _ref$defaultQuery === void 0 ? emptyQuery : _ref$defaultQuery,
  ...
  var findOne = /*#__PURE__*/ (function () {
    var _ref2 = _asyncToGenerator(
      /*#__PURE__*/ _regeneratorRuntime().mark(function _callee(id) {
        var res;
  ...
  var findMany = /*#__PURE__*/ (function () {
    var _ref3 = _asyncToGenerator(
      /*#__PURE__*/ _regeneratorRuntime().mark(function _callee2(query) {
        var loadMore,
          queryParams,
          res,
          _res$data,
              ...
              switch ((_context2.prev = _context2.next)) {
                ...
                case 11:
                  ...
                  if (!loadMore) {
                    ...
                    setResources(
                      [].concat(
                        _toConsumableArray(resources),
                        _toConsumableArray(res.data)
                      )
                    );
                  }
                  if (res.meta) {
  ...
  var create = /*#__PURE__*/ (function () {
    var _ref4 = _asyncToGenerator(
      /*#__PURE__*/ _regeneratorRuntime().mark(function _callee3(resource) {
        var _res$data2, res;
        return _regeneratorRuntime().wrap(
  ...
  var update = /*#__PURE__*/ (function () {
    var _ref5 = _asyncToGenerator(
      /*#__PURE__*/ _regeneratorRuntime().mark(function _callee4(resource) {
        var res;
        return _regeneratorRuntime().wrap(
            ...
            while (1)
              switch ((_context4.prev = _context4.next)) {
                ...
                case 2:
                  ...
                  _context4.next = 8;
                  return api.put(
                    "".concat(url, "/").concat(resource.id),
                    _defineProperty({}, name, resource)
                  );
                case 8:
                  res = _context4.sent;
  ...
  var deleteMany = /*#__PURE__*/ (function () {
    var _ref8 = _asyncToGenerator(
      /*#__PURE__*/ _regeneratorRuntime().mark(function _callee7(ids) {
        var res;
        return _regeneratorRuntime().wrap(
                ...
                case 0:
                  ...
                  Object.keys(resourceWithFiles).forEach(function (key) {
                    if (resourceWithFiles[key]) {
                      formData.append(
                        "".concat(name, "[").concat(key, "]"),
                        resourceWithFiles[key]
                      );
                    }
                  });
                  _context8.next = 9;
            ...
            while (1)
              switch ((_context9.prev = _context9.next)) {
                case 0:
                  ...
                  _context9.next = 8;
                  return api.put(
                    "".concat(url, "/").concat(resourceWithFiles.id),
                    formData,
                    config
                  );
                case 8:
            ...
            while (1)
              switch ((_context10.prev = _context10.next)) {
                case 0:
                  ...
                  _context10.next = 5;
                  return api.post(
                    "".concat(url, "/").concat(id, "/add_items"),
                    {
                      item: {
                        name: resourceName,
                        ids: resourceIds,
            ...
            while (1)
              switch ((_context11.prev = _context11.next)) {
                case 0:
                  ...
                  _context11.next = 5;
                  return api.post(
                    "".concat(url, "/").concat(id, "/remove_items"),
                    {
                      item: {
                        name: resourceName,
                        ids: resourceIds,
  ...
  var updatePositions = /*#__PURE__*/ (function () {
    var _ref13 = _asyncToGenerator(
      /*#__PURE__*/ _regeneratorRuntime().mark(function _callee12(sorted) {
        var resp;
        return _regeneratorRuntime().wrap(
            ...
            while (1)
              switch ((_context13.prev = _context13.next)) {
                case 0:
                  ...
                  _context13.next = 5;
                  return api.post(
                    "".concat(url, "/").concat(id, "/add_attachment"),
                    {
                      attachment: {
                        name: resourceName,
                        id: resourceId,
            ...
            while (1)
              switch ((_context14.prev = _context14.next)) {
                case 0:
                  ...
                  _context14.next = 5;
                  return api.post(
                    "".concat(url, "/").concat(id, "/remove_attachment"),
                    {
                      attachment: {
                        name: resourceName,
                        id: resourceId,
  ...
  var handleErrors = function handleErrors(e) {
    ...
    if (
      (e === null || e === void 0
        ? void 0
        : (_e$response = e.response) === null || _e$response === void 0
        ? void 0
        : _e$response.status) === 401
    ) {
    ...
    if (
      ...
      setErrors(
        e === null || e === void 0
          ? void 0
          : (_e$data2 = e.data) === null || _e$data2 === void 0
          ? void 0
          : _e$data2.errors
      );
    }
